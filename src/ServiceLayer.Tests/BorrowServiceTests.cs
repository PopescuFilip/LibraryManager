...
public class BorrowServiceTests
{
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenThresholdIsTouchedAndBooksOnlyBelongToOneDomain()
    {
        var borrowerId = 1;
        var lenderId = 4;
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBorrowedSameBookLimitIsExceeded()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBookDetailsContainsBookWithLowAvailabilityRation()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBookDetailsContainNonAvailableBooks()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
        ...
        var bookDetails = ids
            .Select(id => new BookDetails(
                id,
                new Book(BookStatus.Borrowed, id) { Id = 1 },
                id,
                51, 51,
                [id]))
            .ToList();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBookDetailsContainsDuplicateEditionId()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
        ...
        var bookDetails = ids
            .Select(id => new BookDetails(
                id,
                new Book(BookStatus.Available, 444) { Id = 1 },
                444,
                51, 51,
                [id]))
            .ToList();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBookDetailsDoNotMatchIdsCount()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBorrowedBooksLimitIsExceeded()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenBorrowedBooksPerDayLimitIsExceeded()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
    ...
    [TestMethod]
    public void Borrow_ShouldReturnFalse_WhenOptionsContainBorrowUntilFromThePast()
    {
        var borrowerId = 1;
        var lenderId = 4;
        var ids = new List<int>() { 1, 4, 5, 7, 9 }.ToIdCollection();
